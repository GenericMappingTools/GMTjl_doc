...
![](/assets/choro1_dcw.png){width="500" .center}
...
{{< gmtref polygonlevels >}} function to get as the population density in the same order as the country polygons are
...
![](/assets/choro2_wpop.png){width="800" .center}
