...
<a href="ternary_examples.html#a-scatter-plot-example"><img src="scatter_thumb.png" class="card-img-top"></a>
<div class="card-body"><a href="ternary_examples.html#a-scatter-plot-example" class="card-title"><strong>Scatter Plot</strong></a></div>
</div>
</div>

<div class="g-col-6 g-col-md-4 g-col-lg-3">
<div class="card h-100">
<a href="ternary_examples.html#ternary-with-image"><img src="image_thumb.png" class="card-img-top"></a>
<div class="card-body"><a href="ternary_examples.html#ternary-with-image" class="card-title"><strong>Ternary with Image</strong></a></div>
</div>
</div>

<div class="g-col-6 g-col-md-4 g-col-lg-3">
<div class="card h-100">
<a href="ternary_examples.html#diagram-with-lines-and-text"><img src="lines_thumb.png" class="card-img-top"></a>
<div class="card-body"><a href="ternary_examples.html#diagram-with-lines-and-text" class="card-title"><strong>Lines and Text</strong></a></div>
</div>
</div>
...
This example makes use of the [tern2cart] function that converts from ternary
