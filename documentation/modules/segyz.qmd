...
- **Jz** or **zscale** : -- *zscale=val*\
   Set the z-axis scaling.

{{< include ../common_opts/opt_R_3D.qmd >}}

- **D** or **dev** or **deviation** : -- *deviation=val* **|** *deviation="devX/devY"*\
...
- **Q** or **adjust** : -- *adjust=(bias=val, dpi=val, redvel=val, xmult=val, dy=val)*\
   ...
   **dy** (or **y**): override sample interval in reel header.

- **S** or **header** or **traceheader** : -- *header=(:c, :o)* **|** *header=(x=:c, y=:o)*\
...
segyz("wa1.segy", proj="X5i/-5i", zscale="0.05i", view=(180,5),
      ...
      header=(:o, :o), wiggle=true, fill=:black, figname="segy.pdf")
```
...
#| output: asis
using GMT
GMT.doc_source_links("segyz")
```

See Also
--------

- {{< gmtref segy >}}, {{< gmtref segy2grd >}}
