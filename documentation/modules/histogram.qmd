...
Reads *file*, MxN matrix, {{< gmtref GMTdataset type=gmttype >}} or {{< gmtref GMTimage type=gmttype >}} and examines the first
...
- **auto** : -- *auto=true*\
   When input is a {{< gmtref GMTimage type=gmttype >}} of UInt16 type this option will compute the histogram as well as good
...
- **full_histo** : -- *full_histo=true*\
   When input is a {{< gmtref GMTimage type=gmttype >}} of UInt16 type histograms are often (*e.g.* Landsat images) characterized
...
- **zoom** : -- *zoom=true*\
   When input is a {{< gmtref GMTimage type=gmttype >}} of UInt16 type this option will set **auto=true** and show histogram only
...
#| output: asis
using GMT
GMT.doc_source_links("histogram")
```
